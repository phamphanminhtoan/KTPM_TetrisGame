...
namespace TetrisMVC.TetrisService {
    ...
    public interface UserServiceSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        bool insertTV(string username, string password, string fullname, int score);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/insertTV", ReplyAction="*")]
        System.Threading.Tasks.Task<bool> insertTVAsync(string username, string password, string fullname, int score);
    ...
    public partial class UserServiceSoapClient : System.ServiceModel.ClientBase<TetrisMVC.TetrisService.UserServiceSoap>, TetrisMVC.TetrisService.UserServiceSoap {
        ...
        public bool insertTV(string username, string password, string fullname, int score) {
            return base.Channel.insertTV(username, password, fullname, score);
        }
        
        public System.Threading.Tasks.Task<bool> insertTVAsync(string username, string password, string fullname, int score) {
            return base.Channel.insertTVAsync(username, password, fullname, score);
        }
