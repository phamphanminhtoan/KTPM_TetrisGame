    ...
    class signUpController
    {
        ...
        public void HandleSignUp(signUp signUp)
        {
            if (checkInput(signUp))
            {
                ...
                reader.setSignUp(signUp.txtUsername.Text, signUp.txtPassword.Password.ToString(), signUp.txtFullname.Text, 0);

                if (reader.checkTV(signUp.txtUsername.Text.ToString()))
                {
                    if (reader.insertTV(signUp.txtUsername.Text, signUp.txtPassword.Password.ToString(), signUp.txtFullname.Text, 0))
